...
//MID定义
#define FAST_DMID_PROTO_STACK 0xFF  /*目的MID为0xFF表示送到内核协议栈*/
...
//PORT and STATUS
#define FAST_PORT_MAC_CORE_CONFIG		0x2		/*MAC核配置地址*/
#define FAST_PORT_MAC_0					0x3		/*MAC0地址寄存器*/
#define FAST_PORT_MAC_1					0x4		/*MAC1地址寄存器*/
...
#define FAST_PORT_NEG_STATUS_10M		(0x0<<10)
#define FAST_PORT_NEG_STATUS_100M		(0x1<<10)
#define FAST_PORT_NEG_STATUS_1G			(0x2<<10)
